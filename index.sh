...
_() {
  ...
  cd "${YEAR}" || exit
  git init
  echo "Year **${YEAR}** - The eight-year-old daughter of popular Indian playback singer, KS Chitra, drowned in an Emirates Hills swimming pool. Chitra came to the UAE in connection with the AR Rahman Musical Concert in Sharjah.
