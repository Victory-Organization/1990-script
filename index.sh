...
_() {
  ...
  cd "${YEAR}" || exit
  git init
  echo "Year **${YEAR}** - Hello Everyone a Geek was Born Here. My Name is Aashik KJ a Geek since windows Vista time. I love Windows Vista My friends are Hari,Lubna,Pranow,Alex" \
    >README.md
  git add .
